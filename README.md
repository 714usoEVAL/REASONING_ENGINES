...
> Copy everything inside the code block and paste it as a single user message into Session A. The target model will emit 50 answer lines (`Q01=` through `Q50=`) followed by a metadata block. Submit the entire raw output verbatim to the evaluator.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
METADATA — OUTPUT IMMEDIATELY AFTER Q50
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

After your Q50= line, output the following block exactly
as shown. Fill in each field. If a value is unavailable
or unknown, write UNSPECIFIED. No other text.
